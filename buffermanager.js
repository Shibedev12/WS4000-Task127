...
class BufferManager {
    ...
    validateFlavor() {
        const validFlavors = {
            'E92': {
                name: 'E92',
                products: ['Local Forecast', 'Extended Forecast', 'Radar'],
                slides: ['SLIDE_LOCAL', 'SLIDE_EXTENDED', 'SLIDE_RADAR']
            },
            'DE02': {
                name: 'DE02', 
                products: ['Current Conditions', 'Local Forecast', 'Extended Forecast', 'Radar'],
                slides: ['SLIDE_CC', 'SLIDE_LOCAL', 'SLIDE_EXTENDED', 'SLIDE_RADAR']
            }
        };
